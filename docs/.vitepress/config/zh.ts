...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message: `Copyright © ${site.since}-present <a href="${site.url}/">${site.name}</a>.` +
			`&nbsp;&nbsp;&nbsp;✧ <a href="${site.url}/#projects">作品</a>` +
			`&nbsp;&nbsp;&nbsp;✧ <a href="${site.url}/#contact">联系方式</a>`,
    },
    docFooter: {
      prev: '上一篇',
      next: '下一篇'
    ...
    // editLink: 个人站仓库建好后在 site.ts 填 repo 再开
